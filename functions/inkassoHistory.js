...
export const recordInkassoCaseUpdated = onDocumentUpdatedWithAuthContext({ region, document: 'inkassoCases/{caseId}' }, async (event) => {
  ...
  const informationFields = ['title', 'description', 'collectionAgency', 'collectionReference', 'debtorName', 'debtorNumber', 'debtorContactName', 'debtorAddress', 'debtorEmail', 'debtorPhone', 'invoiceNumbers', 'invoiceDate', 'originalDueDate', 'lastReminderDate', 'court', 'courtReference', 'paymentOrderDate', 'enforcementOrderDate', 'titleAvailable']

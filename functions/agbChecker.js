...
function prompt(documentText) {
  return [
    ...
    'findings enthält höchstens fünf tatsächlich dokumentierte, besonders relevante negative Bedingungen, insbesondere erforderliche Originale per Post, Subunternehmer- oder Umladeverbote sowie Vertragsstrafen. Keine Rechtsberatung, keine Aussagen zur Wirksamkeit oder Rechtmäßigkeit einer Klausel.',
    `Dokumenttext:\n${documentText}`,
  ].join('\n\n')
}

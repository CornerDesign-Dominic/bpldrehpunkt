...
export const HOLIDAY_TRANSLATIONS_DE = Object.freeze({
  ...
  SE: { ...COMMON, 'National Day of Sweden': 'Schwedischer Nationalfeiertag' },
  NO: { ...COMMON },
  FI: { ...COMMON },
  EE: { ...COMMON, 'Day of Restoration of Independence': 'Tag der Wiederherstellung der Unabhängigkeit', 'Spring Day': 'Frühlingstag' },
  LV: {
    ...COMMON,
    'Day of the Convocation of the Constitutional Assembly of the Republic of Latvia': 'Tag der Einberufung der Verfassungsgebenden Versammlung der Republik Lettland',
    'Day of the Proclamation of the Republic of Latvia': 'Tag der Ausrufung der Republik Lettland',
    'Day of the Restoration of Independence of the Republic of Latvia': 'Tag der Wiederherstellung der Unabhängigkeit der Republik Lettland',
    'Final Day of the Nationwide Latvian Song and Dance Celebration': 'Abschlusstag des landesweiten lettischen Lieder- und Tanzfestes',
    'Jāņi Day': 'Johannistag',
    'Līgo Day': 'Līgo-Tag',
  },
  LT: {
    ...COMMON,
    'Day of Restoration of Independence of Lithuania': 'Tag der Wiederherstellung der Unabhängigkeit Litauens',
    'International Working Day': 'Tag der Arbeit',
    'The Day of Restoration of the State of Lithuania': 'Tag der Wiederherstellung des Staates Litauen',
  },
  BG: {
    ...COMMON,
    'Currency change day': 'Tag der Währungsumstellung',
    'Holy Saturday': 'Karsamstag',
    'Liberation Day': 'Tag der Befreiung',
    'Saint George\'s Day': 'Georgstag',
    'Saints Cyril and Methodius Day': 'Tag der Heiligen Kyrill und Method',
    'Unification Day': 'Tag der Vereinigung',
  },
  GR: { ...COMMON, Annunciation: 'Verkündigung des Herrn', 'Clean Monday': 'Reiner Montag', 'Ochi Day': 'Ochi-Tag' },
  TR: {
    ...COMMON,
    'Atatürk Commemoration & Youth Day': 'Atatürk-Gedenk-, Jugend- und Sporttag',
    'Democracy and National Unity Day': 'Tag der Demokratie und nationalen Einheit',
    'Eid al-Adha First Day': 'Erster Tag des Opferfests',
    'Eid al-Adha First Day (Tentative Date)': 'Erster Tag des Opferfests (vorläufiges Datum)',
    'Eid al-Adha Second Day': 'Zweiter Tag des Opferfests',
    'Eid al-Adha Second Day (Tentative Date)': 'Zweiter Tag des Opferfests (vorläufiges Datum)',
    'Eid al-Adha Third Day': 'Dritter Tag des Opferfests',
    'Eid al-Adha Third Day (Tentative Date)': 'Dritter Tag des Opferfests (vorläufiges Datum)',
    'Eid al-Adha Fourth Day': 'Vierter Tag des Opferfests',
    'Eid al-Adha Fourth Day (Tentative Date)': 'Vierter Tag des Opferfests (vorläufiges Datum)',
    'Eid al-Fitr First Day': 'Erster Tag des Zuckerfests',
    'Eid al-Fitr First Day (Tentative Date)': 'Erster Tag des Zuckerfests (vorläufiges Datum)',
    'Eid al-Fitr Second Day': 'Zweiter Tag des Zuckerfests',
    'Eid al-Fitr Second Day (Tentative Date)': 'Zweiter Tag des Zuckerfests (vorläufiges Datum)',
    'Eid al-Fitr Third Day': 'Dritter Tag des Zuckerfests',
    'Eid al-Fitr Third Day (Tentative Date)': 'Dritter Tag des Zuckerfests (vorläufiges Datum)',
    'National Independence & Children\'s Day': 'Tag der nationalen Souveränität und der Kinder',
    'Republic Day': 'Tag der Republik',
  },
  RS: { ...COMMON, 'Statehood Day': 'Tag der Staatlichkeit' },
})

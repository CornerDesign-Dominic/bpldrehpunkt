...
function ResultStatus({ status, confidence }) {
  ...
  return <span className={`agb-status agb-status--${tone}`}>{isLimited ? 'Mit Einschränkung' : statusLabel[status] || statusLabel.not_found}</span>
}

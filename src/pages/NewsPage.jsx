...
export default function NewsPage() {
  ...
  return <div className="news-page">
    ...
    {category !== 'internal' && <div className="news-external-hint"><p>Die automatische Recherche läuft täglich um 07:00 Uhr. Neue, relevante Meldungen werden mit Quelle und KI-Zusammenfassung in dieser Kategorie gespeichert.</p>{profile?.role === 'superadmin' && <button className="button" type="button" onClick={runResearch} disabled={researching}>{researching ? 'Recherche läuft …' : 'Recherche jetzt starten'}</button>}</div>}

...
export default function VacationManagementPage() {
  ...
  const calendarEntries = useMemo(() => [
    ...
    ...filteredRequests.filter((item) => requestType(item) === 'request' && !['cancelled', 'withdrawn', 'superseded'].includes(requestStatus(item)) && (status === 'all' || requestStatus(item) === status)).flatMap((item) => {

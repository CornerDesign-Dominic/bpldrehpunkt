...
export default function LiabilityLetterPage() {
  ...
  return <div className="liability-page">
    ...
    <div className="liability-page__actions"><button className="button button--secondary" type="button" onClick={() => setAiStep('input')}>Mit KI vorausfüllen</button><button className="button button--secondary" type="button" onClick={printDocument}>PDF drucken</button><button className="button" type="button" disabled={isCreatingPdf} aria-busy={isCreatingPdf} onClick={() => { void createPdf() }}>PDF erstellen</button></div>

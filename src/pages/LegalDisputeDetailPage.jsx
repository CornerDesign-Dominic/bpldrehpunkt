    ...
    <div className="todo-detail-page damage-detail-page legal-dispute-detail-page">
      ...
      <div className="todo-detail-layout">
        ...
        <aside className="todo-detail-sidebar">
          <InformationSection title="Fallinformationen" onEdit={editable ? () => setEditing('information') : null} values={[legalDispute.caseNumber, legalDispute.caseType, legalDispute.responsibleUserName, legalDispute.completedAt]}><Detail label="Interne Fallnummer">{legalDispute.caseNumber}</Detail><Detail label="Art des Falls">{legalDispute.caseType}</Detail><Detail label="Zuständig">{legalDispute.responsibleUserName}</Detail>{legalDispute.isClosed && <Detail label="Abgeschlossen am">{formatTimestamp(legalDispute.completedAt)}</Detail>}</InformationSection>
          ...
          <InformationSection title="Beteiligte" onEdit={editable ? () => setEditing('parties') : null} showEmpty values={[legalDispute.participant, legalDispute.counterparty, legalDispute.opposingCounsel]}><Detail label="Beteiligter">{legalDispute.participant}</Detail><Detail label="Gegenseite">{legalDispute.counterparty}</Detail><Detail label="Gegnerischer Rechtsanwalt">{legalDispute.opposingCounsel}</Detail></InformationSection>

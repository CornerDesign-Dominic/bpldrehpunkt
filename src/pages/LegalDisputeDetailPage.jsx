...
export default function LegalDisputeDetailPage() {
  ...
  return <>
    ...
    <div className="todo-detail-navigation"><BackLink to="/legal-disputes" />{canCreateTodos && <button className="button" type="button" onClick={() => setShowTodoCreate(true)}>To-do anlegen</button>}</div>

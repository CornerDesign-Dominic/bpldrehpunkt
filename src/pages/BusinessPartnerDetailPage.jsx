  ...
  return (
    <div className="detail-page">
      ...
      <div className="detail-grid">
        <DetailSection title="Identifikation"><Detail label="Kurzname" value={partner.shortName} /><Detail label="Debitorennummer" value={partner.debtorNumber} /><Detail label="Kreditorennummer" value={partner.creditorNumber} /></DetailSection>

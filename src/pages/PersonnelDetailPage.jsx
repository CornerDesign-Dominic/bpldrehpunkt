...
const employmentAndVacationFields = [
  ['personnelNumber', 'Personalnummer', 'text'], ['employmentStart', 'Eintrittsdatum', 'date'], ['employmentEnd', 'Austrittsdatum', 'date'], ['annualVacationEntitlement', 'Anspruch Urlaubstage pro Jahr', 'number'], ['vacationTrackingStartYear', 'Startjahr Urlaubserfassung', 'select'], ['vacationTrackingOpeningBalance', 'Anzahl Urlaubstage im Startjahr', 'number'],
]
const hrFields = [

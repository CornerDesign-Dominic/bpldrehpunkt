const pageTitles = [
  ...
  { path: '/kunden-unternehmer/import/unternehmer', title: 'Unternehmer importieren' },
  { path: '/kunden-unternehmer/import', title: 'Stammdaten importieren' },
  { path: '/kunden-unternehmer', title: 'Kunden & Unternehmer' },
  { path: '/transportauftraege/import', title: 'Transportaufträge importieren' },
  { path: '/transportauftraege', title: 'Auftragsliste' },

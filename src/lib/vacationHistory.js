const labels = {
  vacation_pending: 'Urlaub angefragt', vacation_approved: 'Urlaub genehmigt', vacation_manual: 'Urlaub manuell erfasst', vacation_rejected: 'Urlaub abgelehnt', vacation_withdrawn: 'Urlaubsanfrage zurückgezogen',

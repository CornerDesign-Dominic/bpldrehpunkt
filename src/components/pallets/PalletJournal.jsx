...
export default function PalletJournal({ account, accountError, isEntryFormActive, onAddClosing, onAddMovement, onEditMovement, partnersById }) {
  return <section className="pallet-journal">
    ...
    <div className="table-frame"><table><thead><tr><th>Datum</th><th>Art</th><th>Tournummer</th><th>Gegenpartner</th><th><span className="table-header-stack"><span>Ladestelle</span><span>erhalten</span></span></th><th><span className="table-header-stack"><span>Ladestelle</span><span>abgegeben</span></span></th><th><span className="table-header-stack"><span>Entladestelle</span><span>erhalten</span></span></th><th><span className="table-header-stack"><span>Entladestelle</span><span>abgegeben</span></span></th><th>Veränderung</th><th>Palettenschein</th><th><span className="sr-only">Aktion</span></th></tr></thead><tbody>

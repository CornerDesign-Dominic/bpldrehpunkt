...
export default function PalletJournal({ account, accountError, isEntryFormActive, onAddClosing, onAddMovement, onEditMovement, partnersById }) {
  return <section className="pallet-journal">
    ...
    <div className="table-frame"><table><thead><tr><th>Datum</th><th>Art</th><th>Tournummer</th><th>Gegenpartner</th><th>Lade-Zug.</th><th>Lade-Abg.</th><th>Entl.-Zug.</th><th>Entl.-Abg.</th><th>Veränderung</th><th>Palettenschein</th><th><span className="sr-only">Aktion</span></th></tr></thead><tbody>

...
export default function InkassoCaseEditModal({ inkassoCase, mode, onCancel, onSubmit }) {
  ...
  const modalTitle = descriptionOnly ? 'Beschreibung bearbeiten' : titleOnly ? 'Falltitel bearbeiten' : collectionDataOnly ? 'Inkassodaten bearbeiten' : 'Fallinformationen bearbeiten'

...
function initialValues(todo, currentUserId) {
  ...
  return {
    ...
    customerId: todo.customerId || '', customerName: todo.customerName || '', carrierId: todo.carrierId || '', carrierName: todo.carrierName || '', reference: todo.reference || '', damageCaseId: todo.damageCaseId || '',

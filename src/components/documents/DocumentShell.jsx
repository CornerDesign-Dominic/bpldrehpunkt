...
export default function DocumentShell({ children, label = 'Dokumentvorschau' }) {
  return <article className="document-shell" aria-label={label}>
    <div className="document-shell__paper">
      ...
      <div className="document-shell__content">{children}</div>
      <footer className="document-shell__footer">
        ...
        <div><strong>Stadtsparkasse</strong><span>IBAN: DE16 3405 0000 0000 1318 47</span><span>SWIFT: WELADED1XXX</span></div>
      </footer>
    </div>
  </article>
}

...
function initialValues(damageCase) {
  ...
  return {
    ...
    transportReference: damageCase.transportReference || '', claimant: damageCase.claimant || '', contractor: damageCase.contractor || '', responsibleUserId: damageCase.responsibleUserId || '', damageAmount: damageCase.damageAmount ?? '',
  }
}
...
export default function DamageCaseForm({ damageCase, onCancel, onSubmit, users = [] }) {
  ...
  return <form className="damage-form" onSubmit={submit} noValidate>
    ...
    <section className="damage-form__section"><h3>Zuordnung</h3><div className="damage-form__grid damage-form__grid--context">

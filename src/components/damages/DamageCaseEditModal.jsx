...
import { DAMAGE_CASE_STATUSES, DAMAGE_CONTRACTOR_LIABILITY, DAMAGE_INSURANCE_RELEVANCE, DAMAGE_LEGAL_BASES } from '../../lib/damages.js'
...
const sectionFields = {
  ...
  links: ['claimant', 'contractor', 'transportReference', 'damageLocation'],

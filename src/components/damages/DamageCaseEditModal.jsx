...
const sectionFields = {
  ...
  general: ['status', 'damageType', 'damageDate', 'dueDate', 'damageAmount', 'responsibleUserId'],
  links: ['transportReference', 'damageLocation'],
  ...
  liability: ['legalBasis', 'cargoWeightKg', 'liabilityLimit', 'insuranceRelevance', 'bplInsuranceCaseNumber', 'liabilityNote'],
}

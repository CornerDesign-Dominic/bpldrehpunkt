...
const sectionTitles = {
  ...
  schedule: 'Status & Fristen bearbeiten',
  responsibility: 'Zuständigkeit bearbeiten',
  links: 'Verknüpfungen bearbeiten',
  liability: 'Haftung & Versicherung bearbeiten',
}
...
const sectionFields = {
  ...
  liability: ['legalBasis', 'cargoWeightKg', 'liabilityLimit', 'insuranceRelevance', 'bplInsuranceCaseNumber', 'contractorInsurance', 'contractorInsuranceCaseNumber', 'customerInsurance', 'customerInsuranceNumber', 'contractorLiability', 'liabilityNote'],
}
